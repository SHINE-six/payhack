...
export function AuthorizationSection({ institution }: AuthorizationSectionProps) {
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <p>
        You are connecting to {institution.name}. Please log in to authorize access to your account.
        By authorizing, you allow us to securely access your account details per Open Banking standards.
      </p>
      <div>
        <h4 className="font-semibold mb-2">We will access the following data:</h4>
      ...
      <div className="flex items-center space-x-2">
        ...
        >
          I agree to securely share my data with Open Finance App and authorize access to my account.
        </label>
      </div>
      {error && (
      ...
      <p className="text-sm text-muted-foreground">
        Your data will only be used for the purposes outlined in our Terms of Use and Privacy Policy.
        We comply with Open Banking and financial data protection regulations.
      </p>
    </div>
  )
}
